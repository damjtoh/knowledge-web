 ...
 * current Web Projection with Home and Search, and the scrollable content
...
export function AppSidebar({
  ...
  return (
    <Sidebar collapsible="offcanvas" {...props}>
      <SidebarHeader>
        <p className="reader-sidebar-brand px-2 pt-1 text-base font-semibold tracking-tight">
          {title}
        </p>
        <SidebarMenu>
          <SidebarMenuItem>
