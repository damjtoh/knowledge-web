# 04 — Published root cards on Home

**What to build:** A reader chooses a published starting section from responsive Home cards rather than a plain root list.

**Blocked by:** None — can start immediately.

**Status:** ready-for-agent

- [ ] Home shows one card per published root in Publication Manifest navigation order, with a usable link and a distinct note or folder cue.
- [ ] Folder cards show an accurate immediate-child count when meaningful; cards do not invent descriptions or require new frontmatter.
